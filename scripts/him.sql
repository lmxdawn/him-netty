...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户的朋友表';

-- ----------------------------
--  Records of `user_friend`
-- ----------------------------
BEGIN;
INSERT INTO `user_friend` VALUES ('20', '2', '1', '', '0', '4eeee', '2019-05-04 12:53:46', '2019-05-05 03:39:31'), ('21', '1', '2', '', '7', '4eeee', '2019-05-04 12:53:46', '2019-05-05 03:39:31'), ('22', '2', '3', 'fff', '0', '[图片消息]', '2019-05-04 23:32:57', '2019-05-05 01:46:37');
COMMIT;
...
CREATE TABLE `user_friend_msg` (
  ...
  PRIMARY KEY (`msg_id`) USING BTREE,
  KEY `idx_uid` (`uid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户的好友消息表';

-- ----------------------------
--  Records of `user_friend_msg`
-- ----------------------------
BEGIN;
INSERT INTO `user_friend_msg` VALUES ('24', '1', '2', '0', '反反复复', '2019-05-05 02:09:38'), ('25', '1', '2', '0', '是是是', '2019-05-05 02:11:18'), ('26', '1', '2', '0', ':emoji[sunglasses]三生三世', '2019-05-05 02:11:56'), ('27', '1', '1', '0', '毒贩夫妇', '2019-05-05 02:12:42'), ('28', '1', '2', '0', '😋\n', '2019-05-05 02:22:24'), ('29', '1', '2', '0', '😋\n', '2019-05-05 02:24:41'), ('30', '1', '2', '0', '😋\n', '2019-05-05 02:24:46'), ('31', '1', '2', '0', '😋\n', '2019-05-05 02:26:27'), ('32', '1', '2', '0', '?\n', '2019-05-05 02:34:34'), ('33', '1', '2', '0', '?\n', '2019-05-05 02:40:20'), ('34', '1', '2', '0', '?', '2019-05-05 02:42:07'), ('35', '1', '2', '0', '?', '2019-05-05 02:44:22'), ('36', '1', '2', '0', '😆', '2019-05-05 02:46:12'), ('37', '1', '2', '0', '😆', '2019-05-05 02:47:23'), ('38', '1', '2', '0', '😆', '2019-05-05 02:48:28'), ('39', '1', '2', '0', '哈哈哈😆', '2019-05-05 03:03:54'), ('40', '1', '2', '0', '哈哈哈😆', '2019-05-05 03:06:13'), ('41', '1', '2', '0', '哈哈哈😆', '2019-05-05 03:08:33'), ('42', '1', '2', '0', '哈哈😆', '2019-05-05 03:34:28'), ('43', '1', '2', '0', '4444', '2019-05-05 03:34:40'), ('44', '1', '2', '0', '柔柔弱弱', '2019-05-05 03:35:41'), ('45', '1', '2', '0', '4eeee', '2019-05-05 03:39:31');
COMMIT;
